...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { candidate_id: @election.candidate_id, date_of_election: @election.date_of_election, deadline: @election.deadline, position: @election.position, session: @election.session } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { candidate_id: @election.candidate_id, date_of_election: @election.date_of_election, deadline: @election.deadline, position: @election.position, session: @election.session } }
