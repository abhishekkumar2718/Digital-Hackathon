...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { affiliation: @candidate.affiliation, user_id: @candidate.user_id } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { affiliation: @candidate.affiliation, user_id: @candidate.user_id } }
